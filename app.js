...
app.post('/getSignature', function (req, res) {
	var token = 'wechat',
	appsecret = '1c7632b1faf1e4b60e299d4f30b51f21', //你申请的
	APPID ='wxd76f07f57fe513b8',//你申请的id
	url = 'http://15402r8f41.51mypc.cn/index'//JS接口安全域名 参与签名用的
	Res = res;
//发送https get请求 获取 access_token;
https.get("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxd76f07f57fe513b8&secret=1c7632b1faf1e4b60e299d4f30b51f21", function(res) {  
        var datas = [];  
        var size = 0;
